...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.querySelector("#w").addEventListener('input', () => {
        let data = +document.querySelector("#w").value;
        document.querySelector("#output40").innerHTML = data;
        document.querySelector("#w").value = 123;
      });
